...
function renderPhotos(){
    for(i=0; i<PHOTONUM; i++){
        document.body.innerHTML += "<img src='../Media/img"+i+".jpg' style='height: 20vw; z-index: 1; padding: 2%' onclick='selectPhoto("+i+")' id='img"+i+"'>"
    }
}
...
function deselect(){
    document.getElementById("img"+selectedPhoto).src = "../Media/img"+selectedPhoto+".jpg"
