...
function renderPhotos(){
    for(i=0; i<PHOTONUM; i++){
        document.body.innerHTML += "<img src='../Shows/img"+i+".jpg' style='height: 20vw; z-index: 1; padding: 1%' onclick='selectPhoto("+i+")' id='img"+i+"'>"
    }
}
...
function deselect(){
    document.getElementById("img"+selectedPhoto).src = "../Shows/img"+selectedPhoto+".jpg"
