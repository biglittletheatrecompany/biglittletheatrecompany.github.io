...
function renderPhotos(){
    for(i=0; i<PHOTONUM; i++){
        document.body.innerHTML += "<img src='../../Media/img"+i+".jpg' style='height: 30vw; z-index: 1; padding: 1%;' onclick='selectPhoto("+i+")' id='img"+i+"'>"
    }
}
...
function changeImage(direction){
    ...
    console.log(displayedPhoto)
    document.getElementById("img"+selectedPhoto).src = "../../Media/img"+displayedPhoto+".jpg"
